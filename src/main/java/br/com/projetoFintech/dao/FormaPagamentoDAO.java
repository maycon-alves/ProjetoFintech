...
public class FormaPagamentoDAO {
	...
	public void insert(FormaPagamentoModel formaPgto, String user) throws SQLException {
		String sql = "INSERT INTO t_forma_pgto (id_formapgto, nm_nickformapgto, dt_datavencimentofatura, dt_aberturafatura, ds_tipoformapagamento, cd_user) VALUES (SQ_t_forma_pgto.NEXTVAL,?,?,?,?,?)";
		...
		stmt.execute();
		stmt.close();
		System.out.println("forma pagamento inserida");

	}

//	public void insertRelation(String user) throws SQLException {
//		String value = getLastVall();
...
//		stmt2.execute();
//		stmt2.close();
//		System.out.println("Relacionamento concluido");
//	}
//	
//	public String getLastVall() throws SQLException {
//		System.out.println("entrei");
//		String lastIdFormaPgto = null;
//		String sql = "SELECT MAX(id_formapgto) FROM t_forma_pgto";
//		PreparedStatement stmt = conexao.prepareStatement(sql);
...
//		stmt.close();
//		rs.close();
//		System.out.println("ultimo registro de forma pagamento" + lastIdFormaPgto);
